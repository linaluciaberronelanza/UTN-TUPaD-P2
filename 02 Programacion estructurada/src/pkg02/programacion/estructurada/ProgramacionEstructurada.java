...
//Desde main(), solicita el peso del paquete, la zona de envío y el precio del producto. Luego, muestra el total a pagar.
        ...
        double precioProducto1, precioFinal1;

        System.out.println("Ingresa el precio del producto: ");
        precioProducto1 = Double.parseDouble(input11.nextLine());

        precioFinal1 = calcularDescuentoEspecial(precioProducto1, DESCUENTO_ESPECIAL);

        System.out.println("El precio final del producto es: " + precioFinal1);
        ...
        double[] arrayPrecios1 = new double[3];
        ...
        mostrarRecursivo(arrayPrecios1, 0);
        // c. Modificar un precio
        System.out.print("\nElige el índice del producto que deseas modificar (0 a 2): ");
        int indice1 = Integer.parseInt(input13.nextLine());

        if (indice1 >= 0 && indice1 < arrayPrecios1.length) {
            System.out.print("Ingresa el nuevo precio: ");
            arrayPrecios1[indice1] = Double.parseDouble(input13.nextLine());
        } else {
            System.out.println("Índice no válido.");
        }
